...
import FeaturedFirmsGreen from '@/components/FeaturedFirmsGreen';
...
import { SITE_DASHBOARD, SITE_HOME, SITE_MEMBERSHIP } from '@/lib/brand';
import './DemoHeroGreen.css';

const PAGE_BRAND = 'DEGENIE';
    ...
    <Fragment>
      <nav className="demo-nav" aria-label="Primary">
        <div className="demo-nav__inner">
          <a href={SITE_HOME} className="demo-nav__logo" aria-label={`${PAGE_BRAND} home`}>
            <span className="demo-nav__logo-text">
              DE<span className="demo-nav__logo-accent">GENIE</span>
            </span>
          </a>
    ...
    <div className="demo-page demo-page--green">
      ...
      <section className="demo-hero">
        ...
        <div className="hero-cta-row">
          <a href={COMPARE_CTA} className="hero-ghost-cta">
            Compare firms
          ...
          <a href={DISCORD_URL} className="hero-discord-cta">
            Join Discord
          </a>
        </div>
